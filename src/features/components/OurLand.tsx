...
const OurLand = () => {
  return (
    <section className="py-16 bg-gray-100">
      ...
      >
        <p className="text-4xl pt-4 text-[#435061]">Our Lands on Sale</p>
      </div>
      <div className="flex md:max-w-[80%]  max-w-[95%] flex-col md:flex-row items-center justify-center gap-4 mx-auto ">
        {ourLands.map((land) => (
          <div className="max-w-sm bg-white rounded-t-lg w-full md:w-[30%] overflow-hidden">
            ...
            <div className="p-6">
              <Link href={`/lands-properties/${land.id}`}>
                <h2 className="text-xl font-semibold no-underline text-gray-900 mb-2 underline">
                  {land.name}
                </h2>
              </Link>
