...
const Footer = () => {
  ...
  return (
    <footer className="mt-36">
      <div
        className="bg-navy-900 text-white w-full"
        style={{
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 content-center w-[95%] md:w-[80%] mx-auto md:py-16 p-6">
          ...
          <div className="w-full">
            ...
            <div className="space-y-4">
              {blogs.map((blog) => (
                <div
                  className="flex gap-4 border-b-[1px] border-b-gray-500 py-3"
                  key={blog.title}
                >
                  <Image
                    src={blog.banner}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service) => (
                <li
                  key={service.link}
                  className="border-b-[1px] border-b-gray-500 py-2"
                >
                  <Link
                    href={service.link}
          ...
          <div className="flex items-center gap-4">
            {socials.map((social) => (
              <div>
                <Link
                  href="#"
                  className="text-gray-400 hover:text-white rounded-full bg-gray-400"
                >
